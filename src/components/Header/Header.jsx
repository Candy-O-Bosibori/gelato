...
const navigation = [
  ...
  { name: 'My Cart', href: 'mucart', current: false },
]
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-darkcherry text-white' : 'text-gray-300 hover:bg-stone-200 hover:text-darkcherry',
                  ...
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-cherry text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://image.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-260nw-2281862025.jpg"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
